...
{
    public class CommandLabel : CommandPublic
    {
        public string sNameLabel;

        public CommandLabel(ScriptLibMemberMethod parent, CommandBlock parent_block) :
            base(parent, parent_block)
        {
            eCommandType = EnumCommandType.type_label;
        }
