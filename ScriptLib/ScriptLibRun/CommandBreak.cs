...
{
    public class CommandBreak : CommandPublic
    {
        public CommandBreak(ScriptLibMemberMethod parent, CommandBlock parent_block) :
            base(parent, parent_block)
        {
            eCommandType = EnumCommandType.type_break;
        }
