...
{
    public class EditCommandVoidValue : CommandVoidValue
    {
        public EditCommandVoidValue(EditScriptLibMethod parent, CommandBlock parent_block)
        ...
        public override void SaveToStream(ScriptWriter parent_writer, int tab_depth)
        {
            ...
            parent_writer.WriteBlock(EnumBlockType.CommandVoidValue, writer);
        }
