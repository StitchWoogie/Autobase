...
{
    public class EditCommandIf : CommandIf
    {
        public EditCommandIf(EditScriptLibMethod parent, CommandBlock parent_block)
        ...
        public override void SaveToStream(ScriptWriter parent_writer, int tab_depth)
        {
            ...
            parent_writer.WriteBlock(EnumBlockType.CommandIf, writer);
        }
