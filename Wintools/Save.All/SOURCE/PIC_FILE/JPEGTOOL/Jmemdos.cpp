...
short far jdos_open PP((short far * handle, char far * filename));
short far jdos_close PP((short handle));
short far jdos_seek PP((short handle, long offset));
short far jdos_read PP((short handle, void far * buffer,
			       unsigned short count));
short far jdos_write PP((short handle, void far * buffer,
				unsigned short count));
