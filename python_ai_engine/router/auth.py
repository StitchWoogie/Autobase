...
DEFAULT_PERMISSIONS: Dict[str, Optional[str]] = {
    ...
    'codegen/generate': 'codegen.execute',
    'codegen/explain': 'codegen.execute',
    'codegen/fix': 'codegen.execute',
    'codegen/validate': 'codegen.execute',
    'codegen/templates': 'codegen.execute',
    'layout/suggest': 'layout.execute',
    'layout/optimize': 'layout.execute',
    'layout/validate': 'layout.execute',
    'layout/smart-place': 'layout.execute',
