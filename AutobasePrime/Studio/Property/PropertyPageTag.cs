...
namespace Studio
{
	...
	public class PropertyPageTag : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button buttonTagEditor;
		public bool bUseST = false;

		MultiSelectTextBox multiSelectTag = new MultiSelectTextBox();
		...
		public PropertyPageTag()
		{
			...
			multiSelectTag.Add(this.textBoxTag);
		}
		...
		private void InitializeComponent()
		{
            ...
            this.buttonTagEditor = new System.Windows.Forms.Button();
            ...
            // buttonTagEditor
            // 
            this.buttonTagEditor.AccessibleDescription = null;
            this.buttonTagEditor.AccessibleName = null;
            resources.ApplyResources(this.buttonTagEditor, "buttonTagEditor");
            this.buttonTagEditor.BackgroundImage = null;
            this.buttonTagEditor.Font = null;
            this.buttonTagEditor.Name = "buttonTagEditor";
            this.buttonTagEditor.Click += new System.EventHandler(this.buttonTagEditor_Click);
            // 
            // PropertyPageTag
            // 
            ...
            this.Controls.Add(this.buttonTagEditor);
		...
		public void SetTag(string tag)
		{
            ...
            if (pos[0] != TagLib.TAG_NOT_FOUND)
            {
                this.textBoxDes.Text = tp.description;
            }
		}

		public void GetTag(ref string tag)
		{
			this.multiSelectTag.Get(ref tag);
		}
		...
		*/
		...
		private void buttonTagEditor_Click(object sender, System.EventArgs e)
		{
