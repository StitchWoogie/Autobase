...
{
    public partial class PropertyPageObjectControlTabControl : Form
    {
        public PropertyPageObjectControlTabControl()
        {
            InitializeComponent();
        }

        public void SetObjectArgs(ObjectArgsControlTabControl args)
        {
            /*
            int val;
        ...
        public ObjectArgsControlTabControl GetObjectArgs(ObjectArgsControlTabControl org)
        {
            ObjectArgsControlTabControl args = (ObjectArgsControlTabControl)Tools.CopyObject(org);
