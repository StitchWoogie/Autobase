<%@ Page Language="C#" AutoEventWireup="true" Inherits="PortalServerWeb.AutoWeb.MobilePages.WebTagListGroup" Codebehind="WebTagListGroup.aspx.cs" %>
...
<body>
    <form id="Form1" runat="server"><asp:Label ID="Label2" Runat="server" BackColor="#FFE0C0"
        Font-Bold="True" Font-Names="Gulim">웹 그룹 태그 목록</asp:Label> 
    <br />
