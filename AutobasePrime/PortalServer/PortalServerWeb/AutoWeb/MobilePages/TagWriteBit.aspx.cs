...
{
    public partial class TagWriteBit : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                this.LabelValue.Text = String.Format("현재상태:{0}", value);
            }
        }
        ...
        void Write(double val)
        {
            ...
            service.WriteCurrAI(tag, val, AutoLib.DataGate.GetClientGuid());

            string url = String.Format("TagView.aspx?tag={0}", Server.UrlEncode(tag));
            Response.Redirect(url);
        }

        protected void CommandON_Click(object sender, EventArgs e)
        {
            Write(1);
