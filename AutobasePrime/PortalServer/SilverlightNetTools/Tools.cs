	...
	public class Tools 
	{
        ...
        */
		public static bool IsLangKorean()
		{
			...
			if(String.Compare(info.Name, "ko", StringComparison.CurrentCultureIgnoreCase) == 0)
				return true;
            if (String.Compare(info.Name, "ko-kr", StringComparison.CurrentCultureIgnoreCase) == 0)
				return true;
		...
		public static bool IsLangJapanese()
		{
            ...
            if (String.Compare(info.Name, "ja", StringComparison.CurrentCultureIgnoreCase) == 0)
				return true;
            if (String.Compare(info.Name, "ja-jp", StringComparison.CurrentCultureIgnoreCase) == 0)
				return true;
		...
		public static bool IsLangChinese()
		{
            ...
            if (String.Compare(info.Name, 0, "zh-", 0, 3, StringComparison.CurrentCultureIgnoreCase) == 0)
				return true;
        ...
        */
        ...
        public static Color ConvertColor(int color)
        {
            ...
            Color colort = Color.FromArgb(a, r, g, b);
