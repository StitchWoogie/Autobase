...
namespace AutoLibLocal
{
	...
	public class TagAiClass : TagPublicClass
	{
		...
		public float 	fBase;
		public float 	fFull;
		public float 	fPlcBase;
		public float 	fPlcFull;
		public float 	hihi;
		public float 	high;
		public float 	low;
		public float 	lolo;
		...
		public float 	view_full;				// 보여주는 최고 범위
		public float 	view_base;              // 보여주는 최소 범위
		...
		public sbyte	cAlarmProtectOnBigChangeSecond;		// 과 변화가 되었을 때 경보를 지연시키는 기능
		...
		public double		curr;
		public double		old;
        public double       real_curr;      // 비례식이나 각종 계산을 하지 않은 콘트롤러 원시의 값
		...
		public double	sosu_old;					// AI 계산시 표시형식과 일치를 사용하게 되면 누적측정이 되지 않는다. 그 문제를 해결하기위한 변수

		public sbyte		cAlarmProtectOnBigChangeCount;	// 과 변화가 되었을 때 경보를 지연시키는 기능에서 사용하는 기능
