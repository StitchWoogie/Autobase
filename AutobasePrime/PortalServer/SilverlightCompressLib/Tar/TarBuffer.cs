...
*/
		...
		public void SkipBlock()
		{
			...
			if (this.inputStream == null) {
                throw new System.Exception("no input stream defined");
			}
		...
		public byte[] ReadBlock()
		{
			...
			if (this.inputStream == null) {
                throw new System.Exception("TarBuffer.ReadBlock - no input stream defined");
			}
		...
		bool ReadRecord()
		{
			...
			if (this.inputStream == null) {
                throw new System.Exception("no input stream stream defined");
			}
		...
		public void WriteBlock(byte[] block)
		{
			...
			if (this.outputStream == null) {
                throw new System.Exception("TarBuffer.WriteBlock - no output stream defined");
			}
						
			if (block.Length != BlockSize) {
                throw new System.Exception("TarBuffer.WriteBlock - block to write has length '" + block.Length + "' which is not the block size of '" + BlockSize + "'");
			}
		...
		public void WriteBlock(byte[] buf, int offset)
		{
			...
			if (this.outputStream == null) {
                throw new System.Exception("TarBuffer.WriteBlock - no output stream stream defined");
			}
						
			if ((offset + BlockSize) > buf.Length) {
                throw new System.Exception("TarBuffer.WriteBlock - record has length '" + buf.Length + "' with offset '" + offset + "' which is less than the record size of '" + this.recordSize + "'");
			}
		...
		void WriteRecord()
		{
			...
			if (this.outputStream == null)
			{
                throw new System.Exception("TarBuffer.WriteRecord no output stream defined");
			}
		...
		void Flush()
		{
			...
			if (this.outputStream == null) 
			{
                throw new System.Exception("TarBuffer.Flush no output stream defined");
			}
