...
namespace OpcXml.Da
{
	...
	public interface IServer : IDisposable
	{
		...
		/// </summary>
		void Connect(URL url, ConnectData connectData);
		...
		/// </summary>
		void Unsubscribe(string[] subscriptionIDs);
	...
	public class Error 
	{
		...
		/// <remarks/>
		public static readonly XmlQualifiedName E_UNKNOWN_ITEM_NAME        = new XmlQualifiedName("E_UNKNOWN_ITEM_NAME",        Namespace.OPC_DATA_ACCESS_XML10);
		/// <remarks/>
		public static readonly XmlQualifiedName E_INVALID_ITEM_NAME        = new XmlQualifiedName("E_INVALID_ITEM_NAME",        Namespace.OPC_DATA_ACCESS_XML10);
		/// <remarks/>
		public static readonly XmlQualifiedName E_UNKNOWN_ITEM_PATH        = new XmlQualifiedName("E_UNKNOWN_ITEM_PATH",        Namespace.OPC_DATA_ACCESS_XML10);
		/// <remarks/>
		public static readonly XmlQualifiedName E_INVALID_ITEM_PATH        = new XmlQualifiedName("E_INVALID_ITEM_PATH",        Namespace.OPC_DATA_ACCESS_XML10);		
		/// <remarks/>
		...
		/// <remarks/>
		public static readonly XmlQualifiedName E_INVALID_PID              = new XmlQualifiedName("E_INVALID_PID",              Namespace.OPC_DATA_ACCESS_XML10);
		/// <remarks/>
