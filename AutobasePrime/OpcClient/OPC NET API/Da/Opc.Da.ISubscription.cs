...
namespace Opc.Da
{
	...
	public interface ISubscription : IDisposable
	{
		...
		Request BeginRead(Item[] items, object clientHandle, ReadCompleteEventHandler callback);
		...
		/// <param name="callback">The function to invoke when the request completes.</param>
		/// <returns>An identifier for the request (may be used to cancel the request).</returns>
		Request BeginWrite(ItemValue[] items, object clientHandle, WriteCompleteEventHandler callback);
		...
		void Cancel(Request request, CancelCompleteEventHandler callback);
	...
	/// </summary>
	public delegate void DataChangedEventHandler(object subscriptionHandle, ItemValueResult[] values);

	/// <summary>
	/// A delegate to receive asynchronous read completed notifications.
	/// </summary>
	public delegate void ReadCompleteEventHandler(object clientHandle, ItemValueResult[] results);

	/// <summary>
	/// A delegate to receive asynchronous write completed notifications.
	/// </summary>
	public delegate void WriteCompleteEventHandler(object clientHandle, IdentifiedResult[] results);

	/// <summary>
	/// A delegate to receive asynchronous cancel completed notifications.
	/// </summary>
	public delegate void CancelCompleteEventHandler(object clientHandle);
