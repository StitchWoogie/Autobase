...
namespace Opc.Da
{
	...
	{	
		...
		/// <summary>
		/// Begins an asynchronous read of a set of subscription items.
		/// </summary>
		public Request BeginRead(Item[] items, object clientHandle, ReadCompleteEventHandler callback) 
		{ 
			return m_subscription.BeginRead(items, clientHandle, callback); 
		}

		/// <summary>
		/// Begins an asynchronous write of a set of subscription items.
		/// </summary>
		public Request BeginWrite(ItemValue[] items, object clientHandle, WriteCompleteEventHandler callback) 
		{ 
			return m_subscription.BeginWrite(items, clientHandle, callback); 
		}
		
		/// <summary>
		/// Cancels an asynchronous request.
		/// </summary>
		public void Cancel(Request request, CancelCompleteEventHandler callback) 
		{ 
