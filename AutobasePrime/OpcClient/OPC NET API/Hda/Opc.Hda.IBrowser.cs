...
namespace Opc.Hda
{
	...
	public interface IBrowser : IDisposable
	{
		...
		/// <returns>The set of elements that meet the filter criteria.</returns>
		BrowseElement[] Browse(ItemIdentifier itemID, int maxElements, out BrowsePosition position);
		...
		/// <param name="position">The position object used to continue a browse operation.</param>
		/// <returns>The set of elements that meet the filter criteria.</returns>
		BrowseElement[] BrowseNext(int maxElements, ref BrowsePosition position);
	}
	...
	/// </summary>
	[Serializable]
	public class BrowsePosition : IDisposable
	{
