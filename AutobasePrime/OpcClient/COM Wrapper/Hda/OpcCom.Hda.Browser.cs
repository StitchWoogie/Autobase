	...
	{	
		...
		public virtual void Dispose() 
		{
			lock (this)
			{
				...
				if (m_browser != null)
				{
					Marshal.ReleaseComObject(m_browser);
					m_browser = null;
				}
			}
		}
		...
		{
			Opc.Hda.BrowsePosition position = null;
		...
		/// <returns>The set of elements that meet the filter criteria.</returns>
		public BrowseElement[] Browse(ItemIdentifier itemID, int maxElements, out Opc.Hda.BrowsePosition position)
		{
			position = null;
		...
		/// <param name="position">The position object used to continue a browse operation.</param>
		/// <returns>The set of elements that meet the filter criteria.</returns>
		public BrowseElement[] BrowseNext(int maxElements, ref Opc.Hda.BrowsePosition position)
		{
			// check arguments.
