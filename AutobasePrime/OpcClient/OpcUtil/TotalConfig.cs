...
namespace AutoLibLocal
{
	...
	public class TotalConfig
	{
		...
		/*
		public static string AutoBaseIniGetIniPath()
		{
			string win_dir = Tools.GetWindowsRootDirectory();

			return win_dir+"\\autobase.ini";
		}

		static string GetDataDirectory()
		{
			string path = AutoBaseIniGetIniPath();
			string directory="";

			Profile.GetPrivateProfileString("Data", "sDirData", "C:\\CATDATA", ref directory, path);

			return KillEndSlash(directory);
		}
		*/
		...
		{
			//return LoadRegAutoBaseConfig("Supervisor", null, "Admin name", "AUTOBASE");
			return "ADMIN";
		}
		...
		public static string AutoBaseIniGetOemCompanyName()
		{
			...
			return TotalConfig.LoadRegAutoBaseConfig("OEM", null, "Company name", NetTools.Tools.IsLangKorean() ? "(주)한솔테크" : "Hansol Tech");
		}
