...
{
	char *string = "station, type, address, buf address, read size (Master-K10/60/200)";
...
static WORD CalcAddress(char *type, WORD org_address)
{
	...
	if	 (strcmp(type, "D") == 0)	address = 0xB000+org_address;
	else if(strcmp(type, "M") == 0)	address = 0xC000+org_address;
	else if(strcmp(type, "P") == 0)	address = 0xC080+org_address;
	else if(strcmp(type, "K") == 0)	address = 0xC0C0+org_address;
	else if(strcmp(type, "L") == 0)	address = 0xC100+org_address;
	else if(strcmp(type, "F") == 0)	address = 0xC140+org_address;
	else if(strcmp(type, "T") == 0) address = 0xC180+org_address;
	else if(strcmp(type, "C") == 0) address = 0xC1A0+org_address;
	else if(strcmp(type, "S") == 0) address = 0xC200+org_address;
	else if(strcmp(type, "TR") == 0)address = 0xC800+org_address;
	else if(strcmp(type, "CR") == 0)address = 0xCA00+org_address;
	else if(strcmp(type, "TS") == 0)address = 0xCC00+org_address;
	else if(strcmp(type, "CS") == 0)address = 0xCE00+org_address;
	else {
...
int PlcScanReadMasterK10(LOCAL_PORT_STRUCT *pt, int pos)
{
	...
	while(1) {
		...
		if(pt->commRecvBuf[0] == NAK) {
			PlcScanSetErrorString("MASTER-K10/60/200 에서 NAK 신호 반송");
