// TestDoubleInt64Memory.cpp : Defines the initialization routines for the DLL.
//
...
#include "TestDoubleInt64Memory.h"
...
BEGIN_MESSAGE_MAP(CTestDoubleInt64MemoryApp, CWinApp)
END_MESSAGE_MAP()


// CTestDoubleInt64MemoryApp construction

CTestDoubleInt64MemoryApp::CTestDoubleInt64MemoryApp()
{
...
// The one and only CTestDoubleInt64MemoryApp object

CTestDoubleInt64MemoryApp theApp;


// CTestDoubleInt64MemoryApp initialization

BOOL CTestDoubleInt64MemoryApp::InitInstance()
{
...
{
	strcpy(title, "Test Double Int64 Memory");
}
