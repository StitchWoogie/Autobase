// TestDll4.cpp : DLL의 초기화 루틴을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CTestDll4App, CWinApp)
END_MESSAGE_MAP()


// CTestDll4App 생성

CTestDll4App::CTestDll4App()
{
...
BOOL CTestDll4App::InitInstance()
{
...
{
	char* string = "station, type, address, buf address, read size (Test Dll4)";
