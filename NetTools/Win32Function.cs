...
namespace NetTools
{
  ...
  //      [DllImport("winmm.dll")]
        ...
        public static extern bool PlaySound(
			string pszSound,
			IntPtr hmod,
			EnumPlaySound fdwSound);

        /*
        public static int PlaySound(String lpszName, int hModule, EnumPlaySound dwFlags)
        {
            if (lpszName == null) return 0;
            if (!System.IO.File.Exists(lpszName)) return 0;

            System.Media.SoundPlayer player = new System.Media.SoundPlayer(lpszName);
            player.Play();
            return 1;
        }*/
