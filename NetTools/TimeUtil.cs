...
namespace NetTools
{
	...
	public class TimeUtil
	{
        ...
        public static long GetMonHap(DateTime t)
        {
            return GetMonHap(t.Year, t.Month);
        }
		...
		public static long GetDayHap(int year, int month, int day)
		{
            ...
            dayhap += (day - 1);  // 1년 1월 1일이 0이다. 2009.6.19.

			return dayhap;
		}

        public static long GetDayHap(DateTime t)
        {
            return GetDayHap(t.Year, t.Month, t.Day);
        }
        ...
        public static long GetSecHap(DateTime dt)
        {
            return GetMinHap(dt) * 60 + dt.Second;
        }

        public static long GetSecHap(int year, int month, int day, int hour, int min, int sec)
        {
            return GetMinHap(year, month, day, hour, min) * 60 + sec;
        }

        public static long GetMilliSecHap(DateTime dt)
        {
            return GetSecHap(dt) * 1000 + dt.Millisecond;
        }
		...
		public static int GetWeekDay(int year, int month, int day)
		{
            ...
            // 1년 1월 1일이 월요일이므로 날짜에 1을 더해주어 %7로 하여 일요일이 0이 되도록 한다. 2009.7.22
            dayhap += 1;
		...
		static extern bool SetLocalTime([Out]SystemTime st);

		public static bool SetLocalTime(int year, int mon, int day, int hour, int min, int sec)
		{
