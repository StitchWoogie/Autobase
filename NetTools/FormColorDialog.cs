...
namespace NetTools
{
	...
	/// </summary>
	public class FormColorDialog : System.Windows.Forms.Form
	{
		/// <summary>
		...
		bool bMultiFlag = false;
        private TextBox textBoxHex;
        private Label label5;	// 다중 색상이 등록되어 있다.
        public bool bUseAlpha = true;           // 불투명도 사용
		...
		public void SetSelectedColor(Color val, bool first_flag)
		{
			if(first_flag) 
			{
                ...
                UpdateHexFromColor(); //20241010 PSU
		...
		private void InitializeComponent()
		{
            ...
            this.panelZone.Tag = "";
            this.panelZone.DoubleClick += new System.EventHandler(this.panelZone_DoubleClick);
		...
		void EditToColor()
		{
			...
			int r = Convert.ToInt32(numericUpDownR.Value);
			int g = Convert.ToInt32(numericUpDownG.Value);
		...
		private void panelZone_DoubleClick(object sender, System.EventArgs e)
		{
			OK();
		}
